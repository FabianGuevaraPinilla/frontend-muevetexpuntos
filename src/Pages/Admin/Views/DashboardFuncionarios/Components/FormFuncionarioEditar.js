...
export default class FormFuncionarioEditar extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            idCurrentFuncionario: this.props.getIdCurrentRow(),
            rediret: false,
            message: {
                text: '',
                show: false,
    ...
    getdataPremio() {
        ...
        request
            .get(`${urlAPIPremios}/${this.state.idCurrentFuncionario}?simple=true`)
            .then((response) => {
                this.setState({
    ...
    guardarCrudSimple() {
        this.setState({ loading: true });
        request
            .put(`${urlAPIPremios}/${this.state.idCurrentFuncionario}`, this.state.dataPremio)
            .then((response) => {
            ...
            <Container id="crudSimple-crear-container">
                ...
                <Row>
                    <Form>
                        ...
                        <Form.Group className="mb-3" controlId="formBasic">
                            <Form.Label>Categoria Funcionario</Form.Label>
                            <Form.Select
